 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v3$garden$compression$token_fn(p__67624){
var vec__67625 = p__67624;
var tag = cljs.core.nth.call(null,vec__67625,(0),null);
var re = cljs.core.nth.call(null,vec__67625,(1),null);
return ((function (vec__67625,tag,re){
return (function (s){
...
var len__4730__auto___67630 = arguments.length;
var i__4731__auto___67631 = (0);
while(true){
if((i__4731__auto___67631 < len__4730__auto___67630)){
args__4736__auto__.push((arguments[i__4731__auto___67631]));

var G__67632 = (i__4731__auto___67631 + (1));
i__4731__auto___67631 = G__67632;
continue;
} else {
}
break;
...
return (function (p1__67628_SHARP_){
return p1__67628_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
day8.re_frame_10x.inlined_deps.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq67629){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq67629));
});
...
var map__67633 = temp__5733__auto__;
var map__67633__$1 = (((((!((map__67633 == null))))?(((((map__67633.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67633.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67633):map__67633);
var tag = cljs.core.get.call(null,map__67633__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__67633__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__67633__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__67637 = cljs.core.subs.call(null,s1,size);
var G__67638 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__67636 = tag;
...
//# sourceMappingURL=compression.js.map?rel=1563842223182
