...
if((c === "\n")){
var G__60720 = escape_QMARK_;
var G__60721 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__60720;
lines = G__60721;
continue;
} else {
buf.append(c);

var G__60722 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__60723 = lines;
escape_QMARK_ = G__60722;
lines = G__60723;
continue;
...
//# sourceMappingURL=string.js.map?rel=1563842215083
