...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__60745_SHARP_){
var _STAR_delimiter_STAR__orig_val__60746 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__60747 = delimiter;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__60747;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__60745_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__60746;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4736__auto__ = [];
var len__4730__auto___60756 = arguments.length;
var i__4731__auto___60757 = (0);
while(true){
if((i__4731__auto___60757 < len__4730__auto___60756)){
args__4736__auto__.push((arguments[i__4731__auto___60757]));

var G__60758 = (i__4731__auto___60757 + (1));
i__4731__auto___60757 = G__60758;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__60752){
var vec__60753 = p__60752;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__60753,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq60748){
var G__60749 = cljs.core.first.call(null,seq60748);
var seq60748__$1 = cljs.core.next.call(null,seq60748);
var G__60750 = cljs.core.first.call(null,seq60748__$1);
var seq60748__$2 = cljs.core.next.call(null,seq60748__$1);
var G__60751 = cljs.core.first.call(null,seq60748__$2);
var seq60748__$3 = cljs.core.next.call(null,seq60748__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60749,G__60750,G__60751,seq60748__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__60759 = rewrite_clj.reader.peek.call(null,reader);
switch (G__60759) {
case "(":
...
var G__60761 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__60761)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"\"",G__60761)){
...
if(cljs.core._EQ_.call(null,"_",G__60761)){
...
//# sourceMappingURL=core.js.map?rel=1563842215143
