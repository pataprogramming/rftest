...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__62913){
var vec__62914 = p__62913;
var additional = cljs.core.nth.call(null,vec__62914,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__62914,additional){
...
;})(vec__62914,additional))
} else {
return ((function (vec__62914,additional){
return (function (p1__62910_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__62910_SHARP_),t);
});
;})(vec__62914,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq62911){
var G__62912 = cljs.core.first.call(null,seq62911);
var seq62911__$1 = cljs.core.next.call(null,seq62911);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62912,seq62911__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__62920,p__62921){
var map__62922 = p__62920;
var map__62922__$1 = (((((!((map__62922 == null))))?(((((map__62922.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62922.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62922):map__62922);
var row = cljs.core.get.call(null,map__62922__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.call(null,map__62922__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.call(null,map__62922__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.call(null,map__62922__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__62923 = p__62921;
var map__62923__$1 = (((((!((map__62923 == null))))?(((((map__62923.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62923.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62923):map__62923);
var r = cljs.core.get.call(null,map__62923__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.call(null,map__62923__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last.call(null,cljs.core.filter.call(null,(function (p1__62929_SHARP_){
var and__4120__auto__ = p_QMARK_.call(null,p1__62929_SHARP_);
if(cljs.core.truth_(and__4120__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_.call(null,cljs.core.meta.call(null,clojure.zip.node.call(null,p1__62929_SHARP_)),pos);
} else {
return and__4120__auto__;
}
...
var G__62935 = zloc;
var G__62935__$1 = (((G__62935 == null))?null:f.call(null,G__62935));
if((G__62935__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.call(null,G__62935__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.call(null,zloc,f,(function (p1__62937_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__62937_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.call(null,zloc,pos,(function (p1__62944_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__62944_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_.call(null,v))?cljs.core.comp.call(null,v,rewrite_clj.zip.base.sexpr):(function (p1__62951_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.sexpr.call(null,p1__62951_SHARP_),v);
}));
...
//# sourceMappingURL=findz.js.map?rel=1563842217922
