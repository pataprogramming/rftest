...
rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k60627,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k60627,else__4388__auto__);
...
return (function (ret__4407__auto__,p__60632){
var vec__60633 = p__60632;
var k__4408__auto__ = cljs.core.nth.call(null,vec__60633,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__60633,(1),null);
...
rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__60626){
var self__ = this;
var G__60626__$1 = this;
return (new cljs.core.RecordIter((0),G__60626__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this60628,other60629){
var self__ = this;
var this60628__$1 = this;
return (((!((other60629 == null)))) && ((this60628__$1.constructor === other60629.constructor)) && (cljs.core._EQ_.call(null,this60628__$1.children,other60629.children)) && (cljs.core._EQ_.call(null,this60628__$1.__extmap,other60629.__extmap)));
});
...
rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__60626){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__60636 = cljs.core.keyword_identical_QMARK_;
var expr__60637 = k__4393__auto__;
if(cljs.core.truth_(pred__60636.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__60637))){
return (new rewrite_clj.node.uneval.UnevalNode(G__60626,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__60626),null));
}
});
...
rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__60626){
var self__ = this;
var this__4384__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__60626,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__60630){
var extmap__4424__auto__ = (function (){var G__60639 = cljs.core.dissoc.call(null,G__60630,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_.call(null,G__60630)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__60639);
} else {
return G__60639;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__60630),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
...
var G__60641 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__60641;
continue;
}
break;
...
//# sourceMappingURL=uneval.js.map?rel=1563842214858
