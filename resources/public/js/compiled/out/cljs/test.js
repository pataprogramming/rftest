...
var G__49238 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__49238,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__49238;
}
});
...
var len__4730__auto___49243 = arguments.length;
var i__4731__auto___49244 = (0);
while(true){
if((i__4731__auto___49244 < len__4730__auto___49243)){
args__4736__auto__.push((arguments[i__4731__auto___49244]));

var G__49245 = (i__4731__auto___49244 + (1));
i__4731__auto___49244 = G__49245;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq49240){
var G__49241 = cljs.core.first.call(null,seq49240);
var seq49240__$1 = cljs.core.next.call(null,seq49240);
var G__49242 = cljs.core.first.call(null,seq49240__$1);
var seq49240__$2 = cljs.core.next.call(null,seq49240__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49241,G__49242,seq49240__$2);
});
...
var map__49247 = m;
var map__49247__$1 = (((((!((map__49247 == null))))?(((((map__49247.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49247.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__49247):map__49247);
var file = cljs.core.get.call(null,map__49247__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__49247__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__49247__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__49247,map__49247__$1,file,line,column){
return (function (p1__49246_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__49246_SHARP_));
});})(map__49247,map__49247__$1,file,line,column))
...
var temp__5735__auto___49249 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___49249)){
var message_49250 = temp__5735__auto___49249;
cljs.core.println.call(null,message_49250);
} else {
}
...
var temp__5735__auto___49251 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___49251)){
var message_49252 = temp__5735__auto___49251;
cljs.core.println.call(null,message_49252);
} else {
}
...
var output_dir__$1 = (function (){var G__49253 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__49253,"/"].join('');
} else {
return G__49253;
}
})();
...
var G__49255 = exception.stack;
var G__49255__$1 = (((G__49255 == null))?null:clojure.string.split_lines.call(null,G__49255));
var G__49255__$2 = (((G__49255__$1 == null))?null:cljs.core.get.call(null,G__49255__$1,depth));
if((G__49255__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__49255__$2);
}
} else {
...
var vec__49256 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__49256,(0),null);
var column = cljs.core.nth.call(null,vec__49256,(1),null);
var vec__49259 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__49259,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__49259,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__49259,(2),null);
...
var m__$1 = (function (){var G__49262 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__49266 = (function (){var G__49265 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__49265);
} else {
return G__49265;
}
})();
...
return cljs.core.vary_meta.call(null,G__49267,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__49271 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__49271,(0),null);
var types = vec__49271;
...
return cljs.core.map.call(null,(function (p__49274){
var vec__49275 = p__49274;
var ns = cljs.core.nth.call(null,vec__49275,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__49275,(1),null);
return ((function (vec__49275,ns,vars__$1){
return (function (){
...
var G__49278 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1){
return (function (){
var seq__49279 = cljs.core.seq.call(null,vars__$1);
var chunk__49280 = null;
var count__49281 = (0);
var i__49282 = (0);
while(true){
if((i__49282 < count__49281)){
var v = cljs.core._nth.call(null,chunk__49280,i__49282);
var temp__5735__auto___49284 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___49284)){
var t_49285 = temp__5735__auto___49284;
each_fixture_fn.call(null,((function (seq__49279,chunk__49280,count__49281,i__49282,t_49285,temp__5735__auto___49284,v,each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_49285)));
});})(seq__49279,chunk__49280,count__49281,i__49282,t_49285,temp__5735__auto___49284,v,each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1))
);
} else {
}


var G__49286 = seq__49279;
var G__49287 = chunk__49280;
var G__49288 = count__49281;
var G__49289 = (i__49282 + (1));
seq__49279 = G__49286;
chunk__49280 = G__49287;
count__49281 = G__49288;
i__49282 = G__49289;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__49279);
if(temp__5735__auto__){
var seq__49279__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__49279__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__49279__$1);
var G__49290 = cljs.core.chunk_rest.call(null,seq__49279__$1);
var G__49291 = c__4550__auto__;
var G__49292 = cljs.core.count.call(null,c__4550__auto__);
var G__49293 = (0);
seq__49279 = G__49290;
chunk__49280 = G__49291;
count__49281 = G__49292;
i__49282 = G__49293;
continue;
} else {
var v = cljs.core.first.call(null,seq__49279__$1);
var temp__5735__auto___49294__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___49294__$1)){
var t_49295 = temp__5735__auto___49294__$1;
each_fixture_fn.call(null,((function (seq__49279,chunk__49280,count__49281,i__49282,t_49295,temp__5735__auto___49294__$1,v,seq__49279__$1,temp__5735__auto__,each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_49295)));
});})(seq__49279,chunk__49280,count__49281,i__49282,t_49295,temp__5735__auto___49294__$1,v,seq__49279__$1,temp__5735__auto__,each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1))
);
} else {
}


var G__49296 = cljs.core.next.call(null,seq__49279__$1);
var G__49297 = null;
var G__49298 = (0);
var G__49299 = (0);
seq__49279 = G__49296;
chunk__49280 = G__49297;
count__49281 = G__49298;
i__49282 = G__49299;
continue;
}
} else {
...
});})(each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1))
);
});})(each_fixture_fn,G__49278,G__49278__$1,env,once_fixtures,each_fixtures,vec__49275,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1563844583911
