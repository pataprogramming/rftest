...
return [(function (){var pred__54998 = cljs.core.instance_QMARK_;
var expr__54999 = reactive_val;
if(cljs.core.truth_(pred__54998.call(null,reagent.ratom.RAtom,expr__54999))){
return "ra";
} else {
if(cljs.core.truth_(pred__54998.call(null,reagent.ratom.RCursor,expr__54999))){
return "rc";
} else {
if(cljs.core.truth_(pred__54998.call(null,reagent.ratom.Reaction,expr__54999))){
return "rx";
} else {
if(cljs.core.truth_(pred__54998.call(null,reagent.ratom.Track,expr__54999))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1563842209227
