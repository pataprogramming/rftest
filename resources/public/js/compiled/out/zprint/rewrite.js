...
var G__63425 = rewrite_clj.zip.next.call(null,n);
loc = G__63425;
continue;
} else {
var G__63426 = rewrite_clj.zip.next.call(null,loc);
loc = G__63426;
continue;
}
} else {
var G__63427 = rewrite_clj.zip.next.call(null,loc);
loc = G__63427;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__63428 = zloc;
var G__63428__$1 = (((G__63428 == null))?null:rewrite_clj.zip.node.call(null,G__63428));
if((G__63428__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__63428__$1);
}
})())));
});
/**
...
var G__63429 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__63429;
continue;
}
break;
...
var G__63430 = rewrite_clj.zip.right.call(null,nloc);
var G__63431 = cljs.core.conj.call(null,out,nloc);
nloc = G__63430;
out = G__63431;
continue;
} else {
...
var G__63432 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__63433 = cljs.core.next.call(null,new_loc);
var G__63434 = replaced_loc;
nloc = G__63432;
new_loc = G__63433;
last_loc = G__63434;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__63435_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__63435_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__63435_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
}),zprint.rewrite.sort_down);
return new_dep;
});

//# sourceMappingURL=rewrite.js.map?rel=1563842218391
