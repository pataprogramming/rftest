...
var map__72367 = top_item;
var map__72367__$1 = (((((!((map__72367 == null))))?(((((map__72367.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72367.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__72367):map__72367);
var file = cljs.core.get.call(null,map__72367__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__72367__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__72367__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e72366){var _e = e72366;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___72369 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___72369)){
var seen_errors_72370 = temp__5733__auto___72369;
if(cljs.core.truth_(seen_errors_72370.has(self))){
} else {
seen_errors_72370.add(self);

var temp__5735__auto___72371 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___72371)){
var sense_72372 = temp__5735__auto___72371;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_72372)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1563842228222
