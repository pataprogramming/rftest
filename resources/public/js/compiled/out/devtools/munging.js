...
var o56102 = temp__5733__auto__;
var temp__5733__auto____$1 = (o56102["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o56103 = temp__5733__auto____$1;
return (o56103["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__55029__auto__ = f;
return (o__55029__auto__["toString"]).call(o__55029__auto__);
} else {
return "";
}
}catch (e56104){var _ = e56104;
return "";
}});
...
try{var o__55029__auto___56106 = t;
(o__55029__auto___56106["cljs$lang$ctorPrWriter"]).call(o__55029__auto___56106,t,writer);
}catch (e56105){var __56107 = e56105;
}
...
var char_code = (function (){var o__55029__auto__ = (new String(char$));
return (o__55029__auto__["charCodeAt"]).call(o__55029__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__55029__auto__ = String;
return (o__55029__auto__["fromCharCode"]).call(o__55029__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56108 = num_code;
switch (G__56108) {
case (1):
return (185);
...
var o__55029__auto__ = String;
return (o__55029__auto__["fromCharCode"]).call(o__55029__auto__,superscript_code);
});
/**
...
}catch (e56110){var _e__55036__auto__ = e56110;
return false;
}})())){
...
var vec__56111 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__56111,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o56114 = temp__5733__auto__;
var temp__5733__auto____$1 = (o56114["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o56115 = temp__5733__auto____$1;
return (o56115["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__56118){
var vec__56119 = p__56118;
var ns_detector = cljs.core.nth.call(null,vec__56119,(0),null);
...
var G__56125 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__56126 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__56125;
remaining_tokens = G__56126;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq56116){
var G__56117 = cljs.core.first.call(null,seq56116);
var seq56116__$1 = cljs.core.next.call(null,seq56116);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56117,seq56116__$1);
});
...
var vec__56130 = cljs.core.split_with.call(null,(function (p1__56129_SHARP_){
return cljs.core.not_EQ_.call(null,p1__56129_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__56130,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__56130,(1),null);
...
var vec__56136 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__56136,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__56136,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__56139 = cljs.core.rest.call(null,remaining_tokens);
var G__56140 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__56139;
name_tokens = G__56140;
continue;
} else {
...
var vec__56143 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__56143,(0),null);
var arity = cljs.core.nth.call(null,vec__56143,(1),null);
var vec__56146 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__56146,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__56146,(1),null);
var vec__56149 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__56149,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__56149,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__56149,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__56149,(3),null);
...
var vec__56155 = result;
var munged_ns = cljs.core.nth.call(null,vec__56155,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__56155,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__56155,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__56155,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__56155,(4),null);
var arity = cljs.core.nth.call(null,vec__56155,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__56159 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__56159,(0),null);
var args = cljs.core.nth.call(null,vec__56159,(1),null);
var vec__56162 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__56162,(0),null);
var name = cljs.core.nth.call(null,vec__56162,(1),null);
...
var G__56165 = (arity + (1));
var G__56166 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__56167){
var vec__56168 = p__56167;
var arity = cljs.core.nth.call(null,vec__56168,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__56168,(1),null);
...
return cljs.core.get.call(null,arities,p1__56171_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__56172_SHARP_){
return cljs.core.drop.call(null,(2),p1__56172_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__56175){
var vec__56176 = p__56175;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__56176,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq56173){
var G__56174 = cljs.core.first.call(null,seq56173);
var seq56173__$1 = cljs.core.next.call(null,seq56173);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56174,seq56173__$1);
});
...
var G__56182 = arg;
var G__56182__$1 = (((G__56182 instanceof cljs.core.Keyword))?G__56182.fqn:null);
switch (G__56182__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__56184__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__56184__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__56184__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__56184__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__56185 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__56185,(0),null);
var fn_name = cljs.core.nth.call(null,vec__56185,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__56185,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__56185,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__56185,(4),null);
var arity = cljs.core.nth.call(null,vec__56185,(5),null);
...
var o__55029__auto__ = f;
return (o__55029__auto__["getBasis"]).call(o__55029__auto__);
});
/**
...
}catch (e56189){var _e__55036__auto__ = e56189;
...
var G__56190 = (obj[cljs.core.first.call(null,path)]);
var G__56191 = cljs.core.rest.call(null,path);
obj = G__56190;
path = G__56191;
continue;
} else {
...
return (function (accum,p__56192){
var vec__56193 = p__56192;
var bit = cljs.core.nth.call(null,vec__56193,(0),null);
var protocol = cljs.core.nth.call(null,vec__56193,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__56196){
var vec__56197 = p__56196;
var ns = cljs.core.nth.call(null,vec__56197,(0),null);
var name = cljs.core.nth.call(null,vec__56197,(1),null);
var selector = cljs.core.nth.call(null,vec__56197,(2),null);
...
return (function (p__56201){
var vec__56202 = p__56201;
var munged_name = cljs.core.nth.call(null,vec__56202,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__56202,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__56202,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__56200_SHARP_){
return (obj[cljs.core.first.call(null,p1__56200_SHARP_)]);
});})(name,sorted_matches,vec__56202,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1563842210083
