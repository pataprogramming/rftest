...
return (new CustomEvent(event_name,(function (){var obj77787 = ({"detail":data});
return obj77787;
})()));
} else {
...
var f = (function (){var pred__77794 = cljs.core._EQ_;
var expr__77795 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__77794.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__77795))){
return ((function (pred__77794,expr__77795){
return (function (p1__77788_SHARP_){
return console.warn(p1__77788_SHARP_);
});
;})(pred__77794,expr__77795))
} else {
if(cljs.core.truth_(pred__77794.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__77795))){
return ((function (pred__77794,expr__77795){
return (function (p1__77789_SHARP_){
return console.debug(p1__77789_SHARP_);
});
;})(pred__77794,expr__77795))
} else {
if(cljs.core.truth_(pred__77794.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__77795))){
return ((function (pred__77794,expr__77795){
return (function (p1__77790_SHARP_){
return console.error(p1__77790_SHARP_);
});
;})(pred__77794,expr__77795))
} else {
return ((function (pred__77794,expr__77795){
return (function (p1__77791_SHARP_){
return console.log(p1__77791_SHARP_);
});
;})(pred__77794,expr__77795))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__77798){
var map__77799 = p__77798;
var map__77799__$1 = (((((!((map__77799 == null))))?(((((map__77799.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__77799.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__77799):map__77799);
var opts = map__77799__$1;
var eval_fn = cljs.core.get.call(null,map__77799__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__77801_SHARP_){
return new_def.callback(p1__77801_SHARP_);
});})(new_def))
);
...
return (function (p__77802){
var vec__77803 = p__77802;
var ky = cljs.core.nth.call(null,vec__77803,(0),null);
var v = cljs.core.nth.call(null,vec__77803,(1),null);
...
}catch (e77808){if((e77808 instanceof Error)){
var e = e77808;
return not_found;
} else {
throw e77808;
...
//# sourceMappingURL=utils.js.map?rel=1563842230540
